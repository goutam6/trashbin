...
while 1:
	...
	if distance<4:
		print ("hi")
		p.ChangeDutyCycle(2.5)                   # change duty cycle for getting the servo position to 90º
        time.sleep(1)                                      # sleep for 1 second
        #p.ChangeDutyCycle(12.5)                  # change duty cycle for getting the servo position to 180º
        #time.sleep(1)                                     # sleep for 1 second
        p.ChangeDutyCycle(.5)                  # change duty cycle for getting the servo position to 0º
        time.sleep(1)  
	...
	print ("Distance:",distance1,"%")
	               						...
	               						# change duty cycle for getting the servo position to 0º
